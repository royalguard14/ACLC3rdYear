...
# Define the model and tokenizer for translation
...
def wer(reference, hypothesis):
    ...
    wer = distance / max(len(reference), len(hypothesis))
    return wer

reference_transcription = "reference transcription text"
wer_score = wer(reference_transcription, transcription)

# Calculate BLEU score
reference_translation = "reference translation text"
bleu_score = sentence_bleu([reference_translation.split()], final_output.split())
